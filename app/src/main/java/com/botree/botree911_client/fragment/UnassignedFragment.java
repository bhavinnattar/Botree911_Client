...
public class UnassignedFragment extends Fragment implements View.OnClickListener{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_unassigned, container, false);
    ...
    void getData(){
        ...
        for(int i=0; i < Constant.allTickets.size(); i++){
            ...
            if(ticket.getAssingee().equalsIgnoreCase("")){
