...
public class InProgressFragment extends Fragment implements View.OnClickListener {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View rootView = inflater.inflate(R.layout.fragment_inprogress, container, false);
    ...
    void getData(){
        ...
        for(int i = 0; i < Constant.allTickets.size(); i++){
            ...
            if(ticket.getStatus().equalsIgnoreCase("inprogress")){
